...
namespace SuperPOS.UI.TA
{
    public partial class FrmTaPaymentDelivery : XtraForm
    {
        ...
        public FrmTaPaymentDelivery(int id, string chkId, string type, string caller, Hashtable ht, string sBusDate, TaCheckOrderInfo taCheckOrder, string sReadyTime)
        {
            InitializeComponent();
        ...
        public FrmTaPaymentDelivery(List<TaOrderItemInfo> lsOi, int id, string chkId, string type, string caller, Hashtable ht, string sBusDate, TaCheckOrderInfo taCheckOrder, string sReadyTime)
        {
            InitializeComponent();
        ...
        private void btnPrtAll_Click(object sender, EventArgs e)
        {
            ...
            IAsyncResult result = handler.BeginInvoke(checkID, strBusDate, lstOrderItemInfos, WbPrtStatic.PRT_CLASS_ALL,
                wbPrtTemplataTa, PubComm.ORDER_TYPE_DELIVERY, null, null);
        }
        ...
        private void btnPrtAllReceipt_Click(object sender, EventArgs e)
        {
            ...
            DelegatePrintHtml handler = DelegateMy.PrtHtml;
            IAsyncResult result = handler.BeginInvoke(checkID, strBusDate, lstOrderItemInfos, WbPrtStatic.PRT_CLASS_ALL_AND_RECEIPT, wbPrtTemplataTa, PubComm.ORDER_TYPE_DELIVERY, null, null);
        }
        ...
        private void btnPrtBillOnly_Click(object sender, EventArgs e)
        {
            ...
            DelegatePrintHtml handler = DelegateMy.PrtHtml;
            IAsyncResult result = handler.BeginInvoke(checkID, strBusDate, lstOrderItemInfos, WbPrtStatic.PRT_CLASS_BILL, wbPrtTemplataTa, PubComm.ORDER_TYPE_DELIVERY, null, null);
        }
        ...
        private void btnPrtKitOnly_Click(object sender, EventArgs e)
        {
            ...
            IAsyncResult result = handler.BeginInvoke(checkID, strBusDate, lstOrderItemInfos, WbPrtStatic.PRT_CLASS_KITCHEN, wbPrtTemplataTa, PubComm.ORDER_TYPE_DELIVERY, null, null);
        }
        ...
        private WbPrtTemplataTa GetAllPrtInfo()
        {
            ...
            wbPrtTemplataTa.DeliveryFee = string.IsNullOrEmpty(txtDeliveryFee.Text) ? "0.00" : txtDeliveryFee.Text;
