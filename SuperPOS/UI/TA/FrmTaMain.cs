...
namespace SuperPOS.UI.TA
{
    public partial class FrmTaMain : DevExpress.XtraEditors.XtraForm
    {
            ...
            if (treeListOrder.AllNodesCount > 0)
            {
                ...
                if (frmCancelOrder.ShowDialog() == DialogResult.OK)
                {
                    ...
                    if (lstChk.Any())
                    {
                        ...
                        CommonDAL.SaveOrUpdateCheckOrder(taCheck);
        ...
        private TaCheckOrderInfo CreateCheckOrderInfo(List<TaOrderItemInfo> lstTaOI, bool isSave)
        {
            ...
            taCheckOrderInfo.DeliveryFee = (CustID >= 1 && ORDER_TYPE.Equals(PubComm.ORDER_TYPE_DELIVERY)) ? (Convert.ToDecimal(lblDeliveryFee.Text)).ToString("0.00") : @"0.00";
        ...
        private void SaveCheckOrder(List<TaOrderItemInfo> lstTaOI, bool isSave)
        {
            ...
            CommonDAL.OrderItemDeleteAndInsert(lstTaOI, taCheckOrderInfo.BusDate, taCheckOrderInfo.CheckCode);
